    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              Image.asset('assets/images/non fiction books/Atomic Habits.jpg',
              ...
              const Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'A guide to building good habits and breaking bad ones through small, actionable changes.',
          ...
          children: [
            ...
            GestureDetector(
              onTap: (){
               ...
               Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Myviewmore_nonfiction(user: user,))); ///view more page//
              },
              child: const Text(
                'View More',
                style: TextStyle(color: Colors.green, fontSize: 14),
        ...
        ListView(
          ...
          children: [
            _buildScanHistoryItem(
                ...
                'timeAgo',
                true,
                'assets/images/non fiction books/sapiens.jpg',
                'Sapiens',
                'Rs.599',
                context),
            _buildScanHistoryItem(
                ...
                'timeAgo',
                true,
                'assets/images/non fiction books/Educated.jpg',
                'Educated',
                'Rs.599',
                context),
            _buildScanHistoryItem(
                ...
                'timeAgo',
                true,
                'assets/images/non fiction books/Becoming.jpg',
                'Becoming',
                'Rs.599',
                context),
            _buildScanHistoryItem(
                ...
                'timeAgo',
                true,
                'assets/images/non fiction books/The Immortal Life of Henrietta Lacks.jpg',
